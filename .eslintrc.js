...
module.exports = {
  ...
  "extends": [
    "eslint:recommended"
    // "esline:recommended" is a good set of defaults. Also consider
    // "standard" - eslint-config-standard
    // "airbnb" - eslint-config-airbnb
    // regardless of what is extended, the rules below should enforce a mostly consistent style
  ],
  ...
  "rules": {
    ...
    // 🤔 Not enabled, but would consider using for specific projects
    // 🔥 Not enabled, no intention to enable
